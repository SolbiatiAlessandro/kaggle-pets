...
class PredictiveModel(object):
    ...
    specifically for cats, scores 0.14
    
    KNN-classifier, example usage inside KNN.ipynb
    """
    
    def __init__(self, name, neighbors_number=130):
        self.name = name
